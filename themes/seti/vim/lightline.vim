...
let s:p.normal.left     = [ [ s:color7,  s:color0 ], [ s:color0, s:color7  ], [ s:color7,  s:color0 ], [ s:color0, s:color7 ] ]
let s:p.insert.left     = [ [ s:color10, s:color0 ], [ s:color0, s:color10 ], [ s:color10, s:color0 ], [ s:color0, s:color10 ] ]
let s:p.replace.left    = [ [ s:color9,  s:color0 ], [ s:color0, s:color9  ], [ s:color9,  s:color0 ], [ s:color0,  s:color9 ] ]
let s:p.visual.left     = [ [ s:color3,  s:color0 ], [ s:color0, s:color3  ], [ s:color3,  s:color0 ], [ s:color0,  s:color3 ] ]
...
let s:p.insert.info     = [ [ s:color10, s:color0 ] ]
