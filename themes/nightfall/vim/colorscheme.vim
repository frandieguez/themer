...
let s:background = [ 16, "#191119" ]
let s:foreground = [ 17, "#d4d7d6" ]
let s:none       = [ "NONE", "" ]

" black
let s:color0  = [ 0, "#1d141d" ]
let s:color8  = [ 8, "#271720" ]

" red
let s:color1  = [ 1, "#ab3358" ]
let s:color9  = [ 9, "#ab3358" ]

" green
let s:color2  = [ 2, "#a0ba77" ]
let s:color10 = [ 10, "#a0ba77" ]

" yellow
let s:color3  = [ 3, "#ccbd8c" ]
let s:color11 = [ 11, "#ccbd8c" ]

" blue
let s:color4  = [ 4, "#3377aa" ]
let s:color12 = [ 12, "#3377aa" ]

" magenta
let s:color5  = [ 5, "#ba77a9" ]
let s:color13 = [ 13, "#ba77a9" ]

" cyan
let s:color6  = [ 6, "#77a9ba" ]
let s:color14 = [ 14, "#77a9ba" ]

" white
let s:color7  = [ 7, "#d4d7d6" ]
let s:color15 = [ 15, "#f8fcf6" ]

let s:color16 = [ 16, "#191119" ]
let s:color17 = [ 17, "#d4d7d6" ]
let s:color18 = [ 18, "#8a553f" ]
let s:color19 = [ 19, "#8ec43d" ]
let s:color20 = [ 20, "#3d556d" ]
let s:color21 = [ 21, "#43a5d5" ]
let s:color22 = [ 22, "#3a4749" ]
let s:color23 = [ 23, "#ff7944" ]
...
call <SID>set_hi("LineNr",                       s:color8,     s:background, "NONE")
...
call <SID>set_hi("VertSplit",                    s:color8,     s:background, "NONE")
...
call <SID>set_hi("NonText",                      s:color8,     s:background, "NONE")
call <SID>set_hi("Visual",                       s:color3,     s:color8,     "NONE")
call <SID>set_hi("Todo",                         s:color8,     s:none,       "NONE")
